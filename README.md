...
* On your Android, go to the [DOWNLOAD_APP_APK](https://github.com/ArmBot-ECE/ArmBot_Java_Android_Studio/tree/master/DOWNLOAD_APP_APK) folder and click on "ArmBot_app_YYYYMMDD.apk" to download it.
